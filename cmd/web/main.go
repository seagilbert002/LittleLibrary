...
func main() {
	...
	// Book Routes
    http.HandleFunc("/books", bookHandler.BooksListHandler)
	...
	http.HandleFunc("/edit_book/", bookHandler.UpdateBookHandler)
	http.HandleFunc("/search", bookHandler.SearchBooks)
